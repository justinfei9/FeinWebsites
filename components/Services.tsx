...
const Services: React.FC = () => {
  ...
  const features = [
    { icon: "update", title: "Unlimited Revisions", desc: "I don't stop until you're 100% happy with the design. No extra fees, no stress.", color: "#3b82f6" },
    { icon: "code", title: "Custom Hand-Coded", desc: "No templates or slow Website Builders. I write every line of code to ensure your site is fast and secure.", color: "#8b5cf6" },
    { icon: "smartphone", title: "Mobile Friendly", desc: "Your site will look perfect on every device, from iPhones to desktop monitors.", color: "#f43f5e" },
    { icon: "search", title: "SEO Ready", desc: "Built with Google's best practices to help your business get found by local customers.", color: "#10b981" },
    { icon: "person", title: "Personal Partner", desc: "I'm a solo developer. You work directly with me—not a faceless agency or a support ticket.", color: "#f59e0b" },
    { icon: "cloud_done", title: "Hosting & Maintenance", desc: "I handle the 24/7 uptime and technical updates so you can focus on running your business.", color: "#06b6d4" }
  ];
